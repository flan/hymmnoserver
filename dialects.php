	...
	<body>
		...
		<div class="text-basic">
			...
			<ul class="basic-inline" style="font-weight: bold; font-size: 9pt;">
				<li>Central Standard Note (Standard)</li>
				...
				<li>Ancient Metafalss Note (Sacred language from the First Era)</li>
		...
		<div class="text-basic">
			...
			<p>
				...
				Ultimately, because of their resulting political position with Sol Ciel, the words of Metafalss Note came to
