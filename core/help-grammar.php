...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>HYMMNOSERVER - Help - Grammar</title>
...
<?php include 'common/header.xml'; ?>
		...
		<table style="width: 640px;" class="text-basic">
			<tr>
				<td style="width: 640px;" align="left">
					<table>
						<tr>
							<td style="width: 640px;" class="titlecell">
					...
					<table>
						<tr>
							<td style="width: 640px;" class="titlecell">
								⠕ Thought-sound (how it works[unsure about this one]) (■想音（そういん）)
							</td>
						</tr>
					</table>
					<p>
					...
					<table>
						<tr>
							<td style="width: 640px;" class="titlecell">
								⠕ The syntax of thought-sound (■想音の保証定義構文)
							</td>
						</tr>
					</table>
					<p>
...
　1x AAs ixi.（確約定義終了）
					...
					<table>
						<tr>
							<td style="width: 640px;" class="titlecell">
								⠕ Converting to[from?] thought-sound (■想音の裏技)
							</td>
						</tr>
					</table>
					<p>
